...
import com.example.taxiapp.activities.MainActivity;
...
import com.example.taxiapp.providers.GeofireProvider;
    ...
    private void getActiveDrivers() {
        mGeofireProvider.getActiveDrivers(mCurrentLatLng).addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                // Añadir los marcadores de los conductores conectados en la app
                ...
                Marker marker = mMap.addMarker(new MarkerOptions().position(driverLatLng).title("Conductor disponible").icon(BitmapDescriptorFactory.fromResource(R.drawable.icon_vehicle)));
                marker.setTag(key);
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.ACCESS_FINE_LOCATION)) {
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Esta aplicacion requiere de los permisos de ubicación para poder usarse")
